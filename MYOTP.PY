...
sender_email='zainulcharmingboy@gmail.com@gmail.com'
sender_email_password="isidrnoawvulsnpd"
reciever_email='zainulkhan032@gmail.com'#input("enter your email address.")
